...
public class ChipotleJrPlus {
    ...
    public static double calculatePrice(List myBurrito) {
        double price = 3.00 + (0.5 * (myBurrito.size() - Collections.frequency(myBurrito, "none")) +
                (Collections.frequency(myBurrito, "rice_all")*0.5) +
                (Collections.frequency(myBurrito, "meat_all")* 0.5 * 5) +
                (Collections.frequency(myBurrito, "salsa_all")*0.5 * 2) +
                (Collections.frequency(myBurrito, "veggie_all")*0.5)
        );
        return price;
    }
    ...
    public static void main(String[] args){
        ...
        for(int i=0; i<=25; i++) {
            ...
            System.out.println("Burrito " + i + ": " + myBurrito + "   Price: $ " + calculatePrice(myBurrito));
        }
    }
}
